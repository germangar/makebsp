...
typedef struct shaderInfo_s
{
    ...
    char backShader[MAX_QPATH];  // for surfaces that generate different front and
                                 // back passes
    ...
    qboolean noVertexShadows; // no shadows will be casted at this surface in
                              // vertex lighting
    qboolean forceSunLight;   // force sun light at this surface even tho we might
                              // not calculate shadows in vertex lighting
